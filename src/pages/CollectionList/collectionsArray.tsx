...
const MarvelArray: watchCardInfo[] = [
    ...
    {title:"Shang-Chi and the Legend of the Ten Rings",id: 566525 ,type:"movie"},
    ...
    {title:"Doctor Strange in the Multiverse of Madness",id: 453395 ,type:"movie"},
...
const HarryPotterArray: watchCardInfo[] = [
    {title:"Fantastic Beasts and Where to Find Them",id: 259316 ,type:"movie"},
    {title:"Fantastic Beasts: The Crimes of Grindelwald",id: 338952 ,type:"movie"},
    {title:"Fantastic Beasts: The Secrets of Dumbledore",id: 338953 ,type:"movie"},
    ...
    {title:"Harry Potter and the Order of the Phoenix",id: 675 ,type:"movie"},
    {title:"Harry Potter and the Half-Blood Prince",id: 767 ,type:"movie"},
    {title:"Harry Potter and the Deathly Hallows: Part 1",id: 12444 ,type:"movie"},
    {title:"Harry Potter and the Deathly Hallows: Part 2",id: 12445 ,type:"movie"},
]

const StarWarsArray: watchCardInfo[] = [
    {title:"Star Wars: Episode I - The Phantom Menace",id: 1893 ,type:"movie"},
    {title:"Star Wars: Episode II - Attack of the Clones",id: 1894 ,type:"movie"},
    {title:"Star Wars: The Clone Wars",id: 4194 ,type:"tv"},
    {title:"Star Wars: Episode III - Revenge of the Sith",id: 1895 ,type:"movie"},
...
const LordoftheRingsArray: watchCardInfo[] = [
    ...
    {title:"The Hobbit: The Battle of the Five Armies",id: 122917 ,type:"movie"},
    {title:"The Lord of the Rings: The Fellowship of the Ring",id: 120 ,type:"movie"},
    {title:"The Lord of the Rings: The Two Towers",id: 121 ,type:"movie"},
    {title:"The Lord of the Rings: The Return of the King",id: 122 ,type:"movie"},
]


const PiratesOfCaribbeanArray: watchCardInfo[] = [
    {title:"Pirates of the Caribbean: The Curse of the Black Pearl",id: 22 ,type:"movie"},
    {title:"Pirates of the Caribbean: Dead Man's Chest",id: 58 ,type:"movie"},
    {title:"Pirates of the Caribbean: At World's End",id: 285 ,type:"movie"},
    {title:"Pirates of the Caribbean: On Stranger Tides",id: 1865 ,type:"movie"},
    {title:"Pirates of the Caribbean: Dead Men Tell No Tales",id: 166426 ,type:"movie"},
]
...
const TwilightArray: watchCardInfo[] = [
    ...
    {title:"The Twilight Saga: Breaking Dawn - Part 1",id: 50619 ,type:"movie"},
    {title:"The Twilight Saga: Breaking Dawn - Part 2",id: 50620 ,type:"movie"},
]
