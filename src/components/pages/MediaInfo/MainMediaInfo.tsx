...
const MainMediaInfo = ({
  ...
  return (
    ...
    >
      ...
      >
        <Text
          display={details?.runtime || details?.number_of_seasons ? "" : "none"}
        >
          {details?.runtime
        ...
        <Text display={media_certification ? "" : "none"}>
          {media_certification}
        </Text>
