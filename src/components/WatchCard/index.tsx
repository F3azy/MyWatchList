...
const WatchCard = ({givenWidth, id, type, title, SpecImageURL, isLink, minH}: 
  {givenWidth?: string, id: number, type: string, title: string, SpecImageURL: string, isLink: boolean, minH?: string}) => {
